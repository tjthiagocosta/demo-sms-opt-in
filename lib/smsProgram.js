...
export const CARRIER_LIABILITY_DISCLOSURE =
...
export const SMS_PROGRAM_USE_CASES_DESCRIPTION =
  "marketing promotions, account notifications, and two-factor authentication (2FA) codes";

export const CONSENT_DISCLOSURE = `I agree to receive SMS messages from ${BUSINESS_NAME} for ${SMS_PROGRAM_USE_CASES_DESCRIPTION}. No marketing messages. ${MESSAGE_FREQUENCY_DISCLOSURE} ${MESSAGE_RATES_DISCLOSURE} ${STOP_DISCLOSURE} ${HELP_DISCLOSURE} ${CARRIER_LIABILITY_DISCLOSURE} Consent is not a condition of purchase or services. See Terms of Service and Privacy Policy. ${NON_SHARING_DISCLOSURE}`;

export const MARKETING_CONSENT_DISCLOSURE = `By checking this box you agree to receive Marketing SMS from ${BUSINESS_NAME}. Message frequency varies. Message and data rates may apply. Reply HELP for help. STOP to opt out.`;

export const TRANSACTIONAL_CONSENT_DISCLOSURE = `By checking this box you agree to receive Transactional SMS communication regarding account notifications and 2FA, from ${BUSINESS_NAME}. Message frequency may vary. Message and data rates may apply. Reply HELP for help or STOP to opt-out.`;
